...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', '_tests');
            }

            return array (  '_controller' => 'Acme\\DemoBundle\\Controller\\WelcomeController::indexAction',  '_route' => '_tests',);
        }

        if (0 === strpos($pathinfo, '/tests')) {
            // list_groups
            if ($pathinfo === '/tests/groups') {
                return array (  '_controller' => 'Acme\\DemoBundle\\Controller\\WelcomeController::groupsAction',  '_route' => 'list_groups',);
            }

            // add_group
            if ($pathinfo === '/tests/add-group') {
                return array (  '_controller' => 'Acme\\DemoBundle\\Controller\\WelcomeController::addGroupAction',  '_route' => 'add_group',);
            }

            // edit_group
            if (0 === strpos($pathinfo, '/tests/group') && preg_match('#^/tests/group/(?P<id>\\d)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'edit_group')), array (  '_controller' => 'Acme\\DemoBundle\\Controller\\WelcomeController::editGroupAction',));
            }
